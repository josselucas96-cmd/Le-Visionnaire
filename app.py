...
'<div class="portfolio-card portfolio-card-active" style="border-color:#F7931A;">'
'<div class="card-glow" style="background:#F7931A;"></div>'
'<div class="card-accent" style="background:linear-gradient(90deg,#F7931A,#FFB143);"></div>'
'<div class="card-number" style="color:#F7931A;">PORTFOLIO III</div>'
...
'<div class="card-badge-active badge-live" style="background:rgba(247,147,26,0.15); color:#FFB143; border-color:rgba(247,147,26,0.35);">● Live</div>'
'</div></a>'
'</div>',
unsafe_allow_html=True)
