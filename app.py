...
'<div class="portfolio-card portfolio-card-active" style="border-color:#F5B60A;">'
'<div class="card-glow" style="background:#F5B60A;"></div>'
'<div class="card-accent" style="background:linear-gradient(90deg,#F5B60A,#FCD34D);"></div>'
'<div class="card-number" style="color:#F5B60A;">PORTFOLIO II</div>'
...
'<div class="card-badge-active badge-live" style="background:rgba(245,182,10,0.15); color:#FCD34D; border-color:rgba(245,182,10,0.35);">● Live</div>'
'</div></a>'
'<a href="/Nakamoto" target="_self" style="text-decoration:none;">'
'<div class="portfolio-card portfolio-card-active" style="border-color:#FF6A00;">'
'<div class="card-glow" style="background:#FF6A00;"></div>'
'<div class="card-accent" style="background:linear-gradient(90deg,#FF6A00,#FF9A50);"></div>'
'<div class="card-number" style="color:#FF6A00;">PORTFOLIO III</div>'
...
'<div class="card-badge-active badge-live" style="background:rgba(255,106,0,0.15); color:#FF9A50; border-color:rgba(255,106,0,0.35);">● Live</div>'
'</div></a>'
'</div>',
unsafe_allow_html=True)
